...
if __name__ == '__main__':
    ...
    # parser.add_argument('--controller_path', type=str, default='training/models/run_offline_round6/best.policy.pt')
    parser.add_argument('--critical_threshold', type=float, default=-1.0, help='Criticality threshold (default: 0.8 for generating data and 0.5 for testing)')
