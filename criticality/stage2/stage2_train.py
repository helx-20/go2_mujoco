...
if __name__ == '__main__':
    ...
    parser.add_argument('--pos_path', default='/mnt/mnt1/linxuan/go2_data/data/stage2/replay_buffer_pos_critical.npy')
    ...
    parser.add_argument('--pos_ratio', default=0.9, type=float, help='ratio of positive samples in each training batch')
